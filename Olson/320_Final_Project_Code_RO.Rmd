...
ggplot(compare_keen18_play, aes(x = reorder(Team, err), y = err, fill = overrated)) +
  geom_col() + 
  coord_flip() +
  scale_fill_manual(values = c("Overrated" = "darkgreen", "Underrated" = "darkred")) +
  labs(title = "Keener Week 18: Playoff Ranking Error",
       x = "NFL Team",
       y = "Error Between Keener's Rank by the Playoff Result",
       fill = "Overrated?")+
  theme_minimal()
...
ggplot(compare_ls18_play, aes(x = reorder(Team, err), y = err, fill = overrated)) +
  geom_col() + 
  coord_flip() +
  scale_fill_manual(values = c("Overrated" = "darkgreen", "Underrated" = "darkred")) +
  labs(title = "Least Squares' Week 18: Playoff Ranking Error",
       x = "NFL Team",
       y = "Error Between Least Squares's Rank by the Playoff Result",
       fill = "Overrated?")+
  theme_minimal()
...
ggplot(compare_nfles18_play, aes(x = reorder(Team, err), y = err, fill = overrated)) +
  geom_col() + 
  coord_flip() +
  scale_fill_manual(values = c("Overrated" = "darkgreen", "Underrated" = "darkred")) +
  labs(title = "NFL End of Season Rankings: Playoff Ranking Error",
       x = "NFL Team",
       y = "Error Between NFL End of Season's Rank by the Playoff Result",
       fill = "Overrated?")+
  theme_minimal()
```
